...
export default function Journey() {
  ...
  const getCopyClassName = (sectionId) => {
    const baseClass = expandedSections[sectionId]
      ? 'inner-copy journey-copy-expanded'
      : 'inner-copy journey-copy-collapsed';

    const sectionHeights = {
      'the-beginning': 'journey-copy-beginning',
      'research-journey': 'journey-copy-research',
      'youth-vision-india': 'journey-copy-yvi',
      'government-engagement': 'journey-copy-government',
      'varanasi-development': 'journey-copy-varanasi',
      today: 'journey-copy-today',
    };

    return `${baseClass} ${sectionHeights[sectionId] || ''}`.trim();
  };
    ...
    <>
      ...
      <section id="the-beginning" className={beginning.section}>
        <div className={`container ${beginning.split}`}>
          ...
          <div className={getCopyClassName('the-beginning')}>
            <h2>The Beginning</h2>
            ...
            <div className="journey-copy-body">
              ...
              <p>
                ...
                <strong>Science Olympiad Foundation (SOF)</strong>, <strong>Corps Commander (Western Command) Indian Army</strong>, <strong>Mr. Adittya Nath Mubayi</strong> (India's most renowned quiz master and international author), and <strong>CBSE's Heritage India Quiz</strong>, as well as several
            ...
            <button
              type="button"
              className="journey-read-toggle"
              onClick={() => toggleSection('the-beginning')}
            >
              {expandedSections['the-beginning'] ? 'Read less' : 'Read more'}
            </button>
          </div>
        </div>
      </section>
      ...
      <section id="research-journey" className={research.section}>
        <div className={`container ${research.split}`}>
          ...
          <div className={getCopyClassName('research-journey')}>
            ...
            <button
              type="button"
              className="journey-read-toggle"
              onClick={() => toggleSection('research-journey')}
            >
              {expandedSections['research-journey'] ? 'Read less' : 'Read more'}
            </button>
          </div>
        </div>
      </section>
      ...
      <section id="youth-vision-india" className={yvi.section}>
        <div className={`container ${yvi.split}`}>
          ...
          <div className={getCopyClassName('youth-vision-india')}>
            ...
            <button
              type="button"
              className="journey-read-toggle"
              onClick={() => toggleSection('youth-vision-india')}
            >
              {expandedSections['youth-vision-india'] ? 'Read less' : 'Read more'}
            </button>
          </div>
        </div>
      </section>
        ...
        return (
          <section id="government-engagement" className={s.section}>
            <div className={`container ${s.split}`}>
              ...
              <div className={getCopyClassName('government-engagement')}>
                ...
                <button
                  type="button"
                  className="journey-read-toggle"
                  onClick={() => toggleSection('government-engagement')}
                >
                  {expandedSections['government-engagement'] ? 'Read less' : 'Read more'}
                </button>
              </div>
            </div>
          </section>
        ...
        return (
          <section id="varanasi-development" className={s.section}>
            <div className={`container ${s.split}`}>
              ...
              <div className={getCopyClassName('varanasi-development')}>
                ...
                <button
                  type="button"
                  className="journey-read-toggle"
                  onClick={() => toggleSection('varanasi-development')}
                >
                  {expandedSections['varanasi-development'] ? 'Read less' : 'Read more'}
                </button>
              </div>
            </div>
          </section>
        ...
        return (
          <section id="today" className={s.section}>
            <div className={`container ${s.split}`}>
              ...
              <div className={getCopyClassName('today')}>
                ...
                >
                  {expandedSections.today ? 'Read less' : 'Read more'}
                </button>
              </div>
            </div>
          </section>
