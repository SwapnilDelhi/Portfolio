...
export const delegationMeetings = [
  {
    ...
    points: [
      ...
      'Held a professional interaction on research, youth leadership, innovation, nation-building, and youth-centric initiatives.',
      'Exchanged views on strengthening youth participation in public leadership, scientific research, and India\u2019s long-term development.',
    ],
  },
  {
    date: '2025',
    ...
    points: [
      ...
      'Held discussions with the Hon\u2019ble Minister, senior Ministry officials, and Directors on youth development, engagement, empowerment, and leadership.',
      'Exchanged perspectives on strengthening youth participation and nurturing India\u2019s next generation of responsible, innovative, and nation-building leaders.',
    ],
  },
  {
    date: '2025',
    ...
    points: [
      ...
      'Presented recommendations on educational reforms, student engagement, innovation, and youth participation, including suggested enhancements for future CBSE and NCERT academic frameworks.',
      'Held detailed discussions with the Hon\u2019ble Minister, senior Ministry officials, education leaders, and CBSE representatives on strengthening India\u2019s education ecosystem.',
      'Participated in an official interaction over breakfast with Ministry officials, where policy suggestions received encouraging appreciation and constructive discussion.',
      'Had the privilege of interacting with Smt. Mridula Pradhan, exchanging perspectives on education, youth development, and nation-building initiatives.',
    ],
  },
  {
    date: '2025',
    ...
    points: [
      ...
      'Exchanged views on empowering young people to contribute effectively to public service, leadership, and national development.',
      'Received a formal Letter of Appreciation and Letter of Recommendation in recognition of achievements and youth-led initiatives.',
    ],
  },
];

export const governmentDialogues = [
  {
    date: '2025',
...
export const institutionalEngagements = [
